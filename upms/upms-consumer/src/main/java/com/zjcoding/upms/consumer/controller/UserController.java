...
import com.zjcoding.upms.common.entity.User;
import com.zjcoding.upms.consumer.common.ApiResponse;
import com.zjcoding.upms.consumer.common.DataType;
import com.zjcoding.upms.consumer.common.ParamType;
 ...
 * @date 2020/5/11 0011 15:03
 */
@RestController
@RequestMapping("/user")
@Api(tags = "1.0-SNAPSHOT", description = "用户管理", value = "用户管理")
@Slf4j
